...
gtk_image_class_init (GtkImageClass *class)
{
  ...
  /**
   * GtkImage:paintable: (setter set_from_paintable)
   *
  ...
  /**
   * GtkImage:file: (setter set_from_file)
   *
  ...
  /**
   * GtkImage:icon-name: (setter set_from_icon_name)
   *
  ...
  /**
   * GtkImage:gicon: (setter set_from_gicon)
   *
  ...
  /**
   * GtkImage:resource: (setter set_from_resource)
   *
